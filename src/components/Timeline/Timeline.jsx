            ...
            <ul ref={ref} className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                ...
                <li>
                    ...
                    <div className="timeline-end mb-10">
                        ...
                        (Python). This application can be used to perform calculations specific to the world of
                        aeraulics
                        and generate PDF documents using forms. These documents can be signed via the
                        application. <br/> I
                        was able to use the .NET framework for an API for calculations in the world of aerodynamics,
                        powder
                        handling and dust collection.
                    </div>
                    <hr/>
                </li>
                <li>
